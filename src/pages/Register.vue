    ...
    <section class="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            ...
            <div class="md:w-1/2 px-8 md:px-16">
                ...
                <p class="text-xs mt-4 text-[#002D74]">Get Started</p>

                <form action="" class="flex flex-col gap-4">
                    <input class="p-2 mt-8 rounded-xl border-2 border-blue-200" type="text" name="name"
                        placeholder="Fullname">
                    <input class="p-2 rounded-xl border-2 border-blue-200" type="email" name="email"
                        placeholder="Email">
                    <div class="relative">
                        <input class="p-2 rounded-xl border-2 border-blue-200 w-full" type="password" name="password"
